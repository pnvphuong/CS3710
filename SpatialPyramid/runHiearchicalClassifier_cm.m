...
% load sim hierarchy
load('griffinNameHierarchy.mat');
h_sim = griffinCategoryNameHierarchy;

load('caltechTaxonomy.mat');
mn = get_map_names(caltechTaxonomyMap);
root_name = 'conch-snail-crab-mussels-goldfish-octopus-horseshoe-crab-hawksbill-starfish-iguana-snake-toad-frog-skunk-ibis-duck-killer-whale-swan-dolphin-goose-cormorant-hummingbird-penguin-bat-owl-leopards-raccoon-dog-bear-chimp-gorilla-goat-kangaroo-llama-greyhound-elephant-camel-horse-porcupine-zebra-ostrich-giraffe-elk';
out_file = 'accList_cm.mat';
out_hierar = 'evaluationTableHierar_cm.mat';
